...
class EditWednesday_10 extends StatefulWidget {
  const EditWednesday_10({
    Key? key,
    this.schedule,
  ...
  @override
  EditWednesday_10_State createState() {
    return EditWednesday_10_State();
  }
}

class EditWednesday_10_State extends State<EditWednesday_10> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_W_10;
    return Scaffold(
