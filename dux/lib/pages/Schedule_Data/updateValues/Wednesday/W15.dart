...
class EditWednesday_15 extends StatefulWidget {
  const EditWednesday_15({
    Key? key,
    this.schedule,
  ...
  @override
  EditWednesday_15_State createState() {
    return EditWednesday_15_State();
  }
}

class EditWednesday_15_State extends State<EditWednesday_15> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_W_15;
    return Scaffold(
