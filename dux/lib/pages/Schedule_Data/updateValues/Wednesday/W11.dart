...
class EditWednesday_11 extends StatefulWidget {
  const EditWednesday_11({
    Key? key,
    this.schedule,
  ...
  @override
  EditWednesday_11_State createState() {
    return EditWednesday_11_State();
  }
}

class EditWednesday_11_State extends State<EditWednesday_11> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_W_11;
    return Scaffold(
