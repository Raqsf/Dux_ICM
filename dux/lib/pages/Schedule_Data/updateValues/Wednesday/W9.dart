...
class EditWednesday_9 extends StatefulWidget {
  const EditWednesday_9({
    Key? key,
    this.schedule,
  ...
  @override
  EditWednesday_9_State createState() {
    return EditWednesday_9_State();
  }
}

class EditWednesday_9_State extends State<EditWednesday_9> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_W_9;
    return Scaffold(
