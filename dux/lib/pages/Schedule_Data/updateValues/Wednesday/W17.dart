...
class EditWednesday_17 extends StatefulWidget {
  const EditWednesday_17({
    Key? key,
    this.schedule,
  ...
  @override
  EditWednesday_17_State createState() {
    return EditWednesday_17_State();
  }
}

class EditWednesday_17_State extends State<EditWednesday_17> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_W_17;
    return Scaffold(
