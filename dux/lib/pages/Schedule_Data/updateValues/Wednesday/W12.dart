...
class EditWednesday_12 extends StatefulWidget {
  const EditWednesday_12({
    Key? key,
    this.schedule,
  ...
  @override
  EditWednesday_12_State createState() {
    return EditWednesday_12_State();
  }
}

class EditWednesday_12_State extends State<EditWednesday_12> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_W_12;
    return Scaffold(
