...
class EditWednesday_8 extends StatefulWidget {
  const EditWednesday_8({
    Key? key,
    this.schedule,
  ...
  @override
  EditWednesday_8_State createState() {
    return EditWednesday_8_State();
  }
}

class EditWednesday_8_State extends State<EditWednesday_8> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_W_8;
    return Scaffold(
