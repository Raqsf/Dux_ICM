...
class EditMonday_12 extends StatefulWidget {
  const EditMonday_12({
    Key? key,
    this.schedule,
  ...
  @override
  EditMonday_12_State createState() {
    return EditMonday_12_State();
  }
}

class EditMonday_12_State extends State<EditMonday_12> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_M_12;
    return Scaffold(
