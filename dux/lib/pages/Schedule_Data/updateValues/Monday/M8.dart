...
class EditMonday_8 extends StatefulWidget {
  const EditMonday_8({
    Key? key,
    this.schedule,
  ...
  @override
  EditMonday_8_State createState() {
    return EditMonday_8_State();
  }
}

class EditMonday_8_State extends State<EditMonday_8> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_M_8;
    return Scaffold(
