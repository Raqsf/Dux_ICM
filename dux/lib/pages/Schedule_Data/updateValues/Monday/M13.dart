...
class EditMonday_13 extends StatefulWidget {
  const EditMonday_13({
    Key? key,
    this.schedule,
  ...
  @override
  EditMonday_13_State createState() {
    return EditMonday_13_State();
  }
}

class EditMonday_13_State extends State<EditMonday_13> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_M_13;
    return Scaffold(
