...
class EditMonday_17 extends StatefulWidget {
  const EditMonday_17({
    Key? key,
    this.schedule,
  ...
  @override
  EditMonday_17_State createState() {
    return EditMonday_17_State();
  }
}

class EditMonday_17_State extends State<EditMonday_17> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_M_17;
    return Scaffold(
