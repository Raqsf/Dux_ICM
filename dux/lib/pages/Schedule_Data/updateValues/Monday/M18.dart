...
class EditMonday_18 extends StatefulWidget {
  const EditMonday_18({
    Key? key,
    this.schedule,
  ...
  @override
  EditMonday_18_State createState() {
    return EditMonday_18_State();
  }
}

class EditMonday_18_State extends State<EditMonday_18> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_M_18;
    return Scaffold(
