...
class EditMonday_11 extends StatefulWidget {
  const EditMonday_11({
    Key? key,
    this.schedule,
  ...
  @override
  EditMonday_11_State createState() {
    return EditMonday_11_State();
  }
}

class EditMonday_11_State extends State<EditMonday_11> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_M_11;
    return Scaffold(
