...
class EditMonday_16 extends StatefulWidget {
  const EditMonday_16({
    Key? key,
    this.schedule,
  ...
  @override
  EditMonday_16_State createState() {
    return EditMonday_16_State();
  }
}

class EditMonday_16_State extends State<EditMonday_16> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_M_16;
    return Scaffold(
