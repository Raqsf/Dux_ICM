...
class EditMonday_15 extends StatefulWidget {
  const EditMonday_15({
    Key? key,
    this.schedule,
  ...
  @override
  EditMonday_15_State createState() {
    return EditMonday_15_State();
  }
}

class EditMonday_15_State extends State<EditMonday_15> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_M_15;
    return Scaffold(
