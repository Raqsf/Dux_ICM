...
class EditFriday_14 extends StatefulWidget {
  const EditFriday_14({
    Key? key,
    this.schedule,
  ...
  @override
  EditFriday_14_State createState() {
    return EditFriday_14_State();
  }
}

class EditFriday_14_State extends State<EditFriday_14> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_F_14;
    return Scaffold(
