...
class EditFriday_12 extends StatefulWidget {
  const EditFriday_12({
    Key? key,
    this.schedule,
  ...
  @override
  EditFriday_12_State createState() {
    return EditFriday_12_State();
  }
}

class EditFriday_12_State extends State<EditFriday_12> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_F_12;
    return Scaffold(
