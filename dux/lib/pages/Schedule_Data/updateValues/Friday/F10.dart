...
class EditFriday_10 extends StatefulWidget {
  const EditFriday_10({
    Key? key,
    this.schedule,
  ...
  @override
  EditFriday_10_State createState() {
    return EditFriday_10_State();
  }
}

class EditFriday_10_State extends State<EditFriday_10> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_F_10;
    return Scaffold(
