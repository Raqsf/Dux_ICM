...
class EditFriday_9 extends StatefulWidget {
  const EditFriday_9({
    Key? key,
    this.schedule,
  ...
  @override
  EditFriday_9_State createState() {
    return EditFriday_9_State();
  }
}

class EditFriday_9_State extends State<EditFriday_9> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_F_9;
    return Scaffold(
