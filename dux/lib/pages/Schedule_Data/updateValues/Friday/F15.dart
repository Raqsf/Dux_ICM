...
class EditFriday_15 extends StatefulWidget {
  const EditFriday_15({
    Key? key,
    this.schedule,
  ...
  @override
  EditFriday_15_State createState() {
    return EditFriday_15_State();
  }
}

class EditFriday_15_State extends State<EditFriday_15> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_F_15;
    return Scaffold(
