...
class EditFriday_16 extends StatefulWidget {
  const EditFriday_16({
    Key? key,
    this.schedule,
  ...
  @override
  EditFriday_16_State createState() {
    return EditFriday_16_State();
  }
}

class EditFriday_16_State extends State<EditFriday_16> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_F_16;
    return Scaffold(
