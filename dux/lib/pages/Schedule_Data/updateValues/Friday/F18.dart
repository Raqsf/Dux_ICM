...
class EditFriday_18 extends StatefulWidget {
  const EditFriday_18({
    Key? key,
    this.schedule,
  ...
  @override
  EditFriday_18_State createState() {
    return EditFriday_18_State();
  }
}

class EditFriday_18_State extends State<EditFriday_18> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_F_18;
    return Scaffold(
