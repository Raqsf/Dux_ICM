...
class EditTuesday_10 extends StatefulWidget {
  const EditTuesday_10({
    Key? key,
    this.schedule,
  ...
  @override
  EditTuesday_10_State createState() {
    return EditTuesday_10_State();
  }
}

class EditTuesday_10_State extends State<EditTuesday_10> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_T_10;
    return Scaffold(
