...
class EditTuesday_8 extends StatefulWidget {
  const EditTuesday_8({
    Key? key,
    this.schedule,
  ...
  @override
  EditTuesday_8_State createState() {
    return EditTuesday_8_State();
  }
}

class EditTuesday_8_State extends State<EditTuesday_8> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_T_8;
    return Scaffold(
