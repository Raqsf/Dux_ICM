...
class EditTuesday_17 extends StatefulWidget {
  const EditTuesday_17({
    Key? key,
    this.schedule,
  ...
  @override
  EditTuesday_17_State createState() {
    return EditTuesday_17_State();
  }
}

class EditTuesday_17_State extends State<EditTuesday_17> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_T_17;
    return Scaffold(
