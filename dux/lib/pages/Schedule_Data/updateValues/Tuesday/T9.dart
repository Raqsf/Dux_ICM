...
class EditTuesday_9 extends StatefulWidget {
  const EditTuesday_9({
    Key? key,
    this.schedule,
  ...
  @override
  EditTuesday_9_State createState() {
    return EditTuesday_9_State();
  }
}

class EditTuesday_9_State extends State<EditTuesday_9> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_T_9;
    return Scaffold(
