...
class EditTuesday_16 extends StatefulWidget {
  const EditTuesday_16({
    Key? key,
    this.schedule,
  ...
  @override
  EditTuesday_16_State createState() {
    return EditTuesday_16_State();
  }
}

class EditTuesday_16_State extends State<EditTuesday_16> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_T_16;
    return Scaffold(
