...
class EditTuesday_15 extends StatefulWidget {
  const EditTuesday_15({
    Key? key,
    this.schedule,
  ...
  @override
  EditTuesday_15_State createState() {
    return EditTuesday_15_State();
  }
}

class EditTuesday_15_State extends State<EditTuesday_15> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_T_15;
    return Scaffold(
