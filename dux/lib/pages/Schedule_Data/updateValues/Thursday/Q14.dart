...
class EditThursday_14 extends StatefulWidget {
  const EditThursday_14({
    Key? key,
    this.schedule,
  ...
  @override
  EditThursday_14_State createState() {
    return EditThursday_14_State();
  }
}

class EditThursday_14_State extends State<EditThursday_14> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_Q_14;
    return Scaffold(
