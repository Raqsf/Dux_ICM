...
class EditThursday_10 extends StatefulWidget {
  const EditThursday_10({
    Key? key,
    this.schedule,
  ...
  @override
  EditThursday_10_State createState() {
    return EditThursday_10_State();
  }
}

class EditThursday_10_State extends State<EditThursday_10> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_Q_10;
    return Scaffold(
