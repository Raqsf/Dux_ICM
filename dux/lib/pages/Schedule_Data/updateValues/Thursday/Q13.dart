...
class EditThursday_13 extends StatefulWidget {
  const EditThursday_13({
    Key? key,
    this.schedule,
  ...
  @override
  EditThursday_13_State createState() {
    return EditThursday_13_State();
  }
}

class EditThursday_13_State extends State<EditThursday_13> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_Q_13;
    return Scaffold(
