...
class EditThursday_8 extends StatefulWidget {
  const EditThursday_8({
    Key? key,
    this.schedule,
  ...
  @override
  EditThursday_8_State createState() {
    return EditThursday_8_State();
  }
}

class EditThursday_8_State extends State<EditThursday_8> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_Q_8;
    return Scaffold(
