...
class EditThursday_17 extends StatefulWidget {
  const EditThursday_17({
    Key? key,
    this.schedule,
  ...
  @override
  EditThursday_17_State createState() {
    return EditThursday_17_State();
  }
}

class EditThursday_17_State extends State<EditThursday_17> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_Q_17;
    return Scaffold(
