...
class EditThursday_15 extends StatefulWidget {
  const EditThursday_15({
    Key? key,
    this.schedule,
  ...
  @override
  EditThursday_15_State createState() {
    return EditThursday_15_State();
  }
}

class EditThursday_15_State extends State<EditThursday_15> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_Q_15;
    return Scaffold(
