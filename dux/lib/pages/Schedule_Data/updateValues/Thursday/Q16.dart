...
class EditThursday_16 extends StatefulWidget {
  const EditThursday_16({
    Key? key,
    this.schedule,
  ...
  @override
  EditThursday_16_State createState() {
    return EditThursday_16_State();
  }
}

class EditThursday_16_State extends State<EditThursday_16> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_Q_16;
    return Scaffold(
