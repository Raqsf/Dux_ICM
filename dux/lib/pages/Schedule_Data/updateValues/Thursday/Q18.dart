...
class EditThursday_18 extends StatefulWidget {
  const EditThursday_18({
    Key? key,
    this.schedule,
  ...
  @override
  EditThursday_18_State createState() {
    return EditThursday_18_State();
  }
}

class EditThursday_18_State extends State<EditThursday_18> {
  ...
  Widget build(BuildContext context) {
    subjectController.text =
        Provider.of<SchedulelProvider>(context, listen: false).subject_Q_18;
    return Scaffold(
