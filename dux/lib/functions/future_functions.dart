...
Future refreshOrGetAnnotationsData(BuildContext context) async {
  await Provider.of<LabelProvider>(context, listen: false).fetchAndSet();
  Provider.of<AnnotationProvider>(context, listen: false).fetchAndSet();
}

Future refreshOrGetHomeData(BuildContext context) async {
  await Provider.of<StepsProvider>(context, listen: false).fetchAndSet();
...
Future refreshOrGetScheduleData(BuildContext context) async {
  await Provider.of<SchedulelProvider>(context, listen: false).fetchAndSet();
  Provider.of<SchedulelProvider>(context, listen: false).getItemMonday8();
  Provider.of<SchedulelProvider>(context, listen: false).getItemMonday9();
  Provider.of<SchedulelProvider>(context, listen: false).getItemMonday10();
  Provider.of<SchedulelProvider>(context, listen: false).getItemMonday11();
